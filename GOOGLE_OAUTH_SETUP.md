...
**Application URL:** https://procurify.preview.emergentagent.com
...
```
https://procurify.preview.emergentagent.com/api/auth/callback/google
```

### 4. Also Add (Optional but Recommended)
For JavaScript origins:
```
https://procurify.preview.emergentagent.com
```
...
1. Going to: https://procurify.preview.emergentagent.com
...
## Current Error
You're getting: `https://procurify.preview.emergentagent.com/auth/error?error=AccessDenied`
