...
**Application URL:** https://inventory-hub-423.preview.emergentagent.com
...
```
https://inventory-hub-423.preview.emergentagent.com/api/auth/callback/google
```

### 4. Also Add (Optional but Recommended)
For JavaScript origins:
```
https://inventory-hub-423.preview.emergentagent.com
```
...
1. Going to: https://inventory-hub-423.preview.emergentagent.com
...
## Current Error
You're getting: `https://inventory-hub-423.preview.emergentagent.com/auth/error?error=AccessDenied`
