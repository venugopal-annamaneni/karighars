...
**Application URL:** https://interior-finance.preview.emergentagent.com
...
```
https://interior-finance.preview.emergentagent.com/api/auth/callback/google
```

### 4. Also Add (Optional but Recommended)
For JavaScript origins:
```
https://interior-finance.preview.emergentagent.com
```
...
1. Going to: https://interior-finance.preview.emergentagent.com
...
## Current Error
You're getting: `https://interior-finance.preview.emergentagent.com/auth/error?error=AccessDenied`
